...
- Upgrade the public CI model-assurance pin from FlowGuard v0.58.5 to v0.66.0 and make the release-facing suite consume the current model-system authority audit, so clean GitHub validation can verify the same content-addressed authority class used locally.
