...
- Active-task feedback writes only the durable observation episode and terminal receipt. Sleep remains the sole normal-runtime owner of lifecycle admission, candidate creation, model publication, and index publication; feedback never synchronously replays lifecycle history or substitutes another path.
