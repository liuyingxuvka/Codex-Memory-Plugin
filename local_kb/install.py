...
SLEEP_AUTOMATION_PROMPT = (
    ...
    "before the outer hard timeout. The complete Sleep plus Dream cycle uses a 2400-second native timeout inside a 2700-second owner timeout; "
    "timeout never means success and requires confirmed zero-descendant cleanup. Report previous_remaining, newly_eligible, opening_remaining, target_batch_size, "
