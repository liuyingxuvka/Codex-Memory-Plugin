...
AUTOMATION_COMPLETION_CONTRACTS: dict[str, dict[str, Any]] = {
    "kb-sleep-maintenance": {
        ...
        "prompt_markers": [
            ...
            "closing_remaining",
            "convergence_status",
            "Classify the terminal counts as",
            "Dream admission",
            "read-only writer policy",
            "deterministic local-cycle postflight",
        ...
        "obligations": [
            ...
            _obligation("atomic-model-generation", "verify", "closure", "Publish the complete model, mesh, deterministic projection, active index, generation manifest, and pointer as one rollbackable generation with the pointer last.", "test_committed_generation_switches_authority_and_index_as_one_fenced_pair", "test_failed_index_publication_restores_prior_generation_and_projection", "test_foreground_reads_pointer_bound_immutable_artifact_not_mutable_yaml"),
            ...
            _obligation("terminal-convergence-classification", "verify", "closure", "Classify no_op, settled, backlog_reduced, backlog_growing, and no_convergence from one canonical remainder rule without relabeling an open batch.", "test_next_cycle_compares_closing_remainder_and_reports_growth", "test_sleep_progress_saved_receipt_rejects_remaining_mismatch"),
    ...
    "kb-dream-pass": {
        ...
        "prompt_markers": [
            ...
            "typed performed or not_applicable disposition",
            "exact parent cycle/phase identity",
            "read-only simulation writer policy",
        ...
        "obligations": [
            ...
            _obligation("perturbation-disposition-coverage", "execute", "workflow", "Emit one typed performed or not_applicable disposition for every declared perturbation kind, with a materialization fingerprint for performed paths and a reason for skipped paths.", "test_dream_probe_covers_model_roles_cross_edge_and_neighbor_pin"),
